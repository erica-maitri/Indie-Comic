"""
RUN FULL SD 1.5 PIPELINE - T4 OPTIMIZED
Generates character and comic panels from LangChain fusion output
Optimized for T4 GPU with memory management (Fast Mode)
"""
...
print("=" * 70)
print("RUNNING FULL SD 1.5 PIPELINE - T4 OPTIMIZED")
print("Executing neural canvas generations (SD 1.5 - Fast Mode)")
print("=" * 70)
...
def check_gpu_memory():
    ...
    if torch.cuda.is_available():
        ...
        # SD 1.5 is lighter, needs about 6-8GB
        if free < 3.0:
            print(f"  ⚠️ Very low VRAM ({free:.1f}GB). SD 1.5 needs ~6GB.")
...
print("\n" + "=" * 70)
print("STEP 1/2: Generating Character Reference (SD 1.5)")
print("=" * 70)
...
print("\n" + "=" * 70)
print("STEP 2/2: Generating Story Components (SD 1.5)")
print("=" * 70)
...
print("\n" + "=" * 70)
print("✅ FULL SD 1.5 PIPELINE COMPLETE!")
print("=" * 70)
print("\n📁 Output files:")
